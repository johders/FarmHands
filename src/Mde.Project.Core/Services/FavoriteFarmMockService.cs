...
namespace Mde.Project.Core.Services
{
  ...
  //      public Task<ResultModel<IEnumerable<Farm>>> GetAllFavoriteFarmsByUserAsync(string uid)
  //      {
  //          throw new NotImplementedException();
  //      }

  //      public Task<BaseResultModel> CreateByUserAsync(string uid, string farmId)
  //      {
  //          throw new NotImplementedException();
  //      }

  //      public Task<BaseResultModel> DeleteByUserAsync(string uid, string farmId)
  //      {
  //          throw new NotImplementedException();
  //      }

  //      public Task<BaseResultModel> IsUserFavoritedAsync(string uid, string farmId)
  //      {
  //          throw new NotImplementedException();
  //      }
  //  }
