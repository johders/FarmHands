...
namespace Mde.Project.Core.Data
{
	public class Seeder
	{
		...
		{
			new Product(Guid.Parse("ed424125-427c-4959-bcf8-4dd73b2691e1"), "Apples", "Freshly picked, juicy apples.", Unit.Kilogram, 3.99m, "https://example.com/apple.jpg"),
			new Product(Guid.Parse("406af47f-1bef-4b6d-86d1-c55cfefdc85d"), "Carrots", "Organic carrots, straight from the farm.", Unit.Kilogram, 1.89m, "https://example.com/carrots.jpg"),
			new Product(Guid.Parse("cf387bb6-f724-4718-b3f3-09613a4022f3"), "Free-Range Eggs", "Dozen of farm fresh eggs.", Unit.Dozen, 4.50m, "https://example.com/eggs.jpg"),
			new Product(Guid.Parse("75197c7e-eac1-402b-b187-f2974f78dc85"), "Milk", "Fresh cow milk, non-pasteurized.", Unit.Litre, 1.20m, "https://example.com/milk.jpg"),
			new Product(Guid.Parse("12bc9732-e3a4-4c14-ad94-214a0e6a9592"), "Tomatoes", "Plump and ripe tomatoes.", Unit.Kilogram, 2.50m, "https://example.com/tomatoes.jpg"),
			new Product(Guid.Parse("70ff9cd2-82d8-4235-b10d-56e7c9c54af2"), "Pumpkin", "Seasonal pumpkins, great for pies.", Unit.Piece, 5.99m, "https://example.com/pumpkin.jpg"),
			...
			new Product(Guid.Parse("8e35ca1e-5616-4e26-a39b-6c1244b8cf8c"), "Honey", "Organic honey from local bees.", Unit.Litre, 10.00m, "https://example.com/honey.jpg"),
